...
| **Fitxategiak** | `data/` karpetako fitxategiak kudeatu: nabigatu, **igo**, **ezabatu**, **izena aldatu**, **karpeta sortu**. Irudiek miniatura-aurrebista dute, PDFek esteka. Onartuak: jpg, png, gif, webp, pdf. Itzulien etapa-profilak `Etapen Profila/<kirola>/<kirola>NN/EtapaN.jpg` izena behar dute; klasikoen irudiek `js/txapelketak.js`-eko `irudiak` mapa (eskuz). Ikus [apiak.md](apiak.md) eta [garapena.md](garapena.md) (`data/` orain zerbitzari-jabetzakoa da) |
